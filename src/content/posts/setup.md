...
pubDate: 2024-07-28
categories: [Blogging]
description: A guide on how to write a post in the Chirpy template
---
...
_Note: The posts' layout has been set to post by default, so there is no need to add the variable layout in Front Matter block._
...
_The benefit of reading the author information from the file \_data/authors.yml is that the page will have the meta tag twitter:creator, which enriches the Twitter Cards and is good for SEO._
...
_A Bug: https://github.com/cotes2020/jekyll-theme-chirpy/issues/1090_
