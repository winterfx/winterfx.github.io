...
## Architecture
![Alt text](/winterfx.github.io/assets/image.png)
...
1. 在配置公众号的服务器设置时，如果使用laf给的地址，提交会失败，说这个地址有风险。所以我们要在laf中将它给的地址，托管到我们自己的域名(支持https)下面，所以你还需要有个域名hhh。
    ![Alt text](/winterfx.github.io/assets/image-1.png)

    ![Alt text](/winterfx.github.io/assets/image-2.png)
...
![Alt text](/winterfx.github.io/assets/image-3.png)

    
![Alt text](/winterfx.github.io/assets/image-4.png)

![Alt text](/winterfx.github.io/assets/image-5.png)
